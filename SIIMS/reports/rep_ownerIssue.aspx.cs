...
namespace SIIMS
{
    public partial class rep_ownerIssue : System.Web.UI.Page
    {
        string _connStr;
        protected static readonly ILog Log = LogManager.GetLogger("rep_ownerIssue");
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("rep_ownerIssue_listing.aspx?sid=" + _emp_sid);
        }
    }
}