...
namespace SIIMS
{
    public partial class rep_ownerAction : System.Web.UI.Page
    {
        string _connStr;
        protected static readonly ILog Log = LogManager.GetLogger("rep_ownerAction");
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("rep_ownerAction_listing.aspx?sid=" + _emp_sid);
        }
    }
}