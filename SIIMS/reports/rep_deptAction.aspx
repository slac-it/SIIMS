<%@ Page Title="Actions By Directorate" Language="C#" MasterPageFile="~/user.Master" AutoEventWireup="true" CodeBehind="rep_deptAction.aspx.cs" Inherits="SIIMS.rep_deptAction" %>
    ...
    <div>
      ...
      <br /><br />
       ...
       <asp:label id="lblMessage" runat="server" Width="90%" Font-Size="1.0em" Font-Names="Arial,Verdana,Helvetica">
                        Please enter the first few characters of the manager's last name: </asp:label>
                <br />  <br />
