<%@ Page Title="Issue by Organization" Language="C#" MasterPageFile="~/user.Master" AutoEventWireup="true" CodeBehind="rep_orgIssue.aspx.cs" Inherits="SIIMS.rep_orgIssue" %>
...
<tr > <td style="padding:0px; margin:0;">
 <asp:GridView ID="GV_OrgIssues" AllowPaging="True" BackColor="#F1F1F1"  width="100%" CellSpacing="5" PageSize="20"
            AutoGenerateColumns="False" DataSourceID="ds_orgIssues" DataKeyNames="org_id"
...
<ItemStyle HorizontalAlign="Left"></ItemStyle>
			    ...
			    <asp:HyperLinkField DataNavigateUrlFields="org_id" DataTextField="total" HeaderText="Total" DataNavigateUrlFormatString="rep_orgIssue_Listing.aspx?org_id={0}" />
...
count(case when issue.status_id = 10 then 1 end) as NDraft,
...
where issue.is_active='Y' and issue.org_id is not null
