...
namespace SIIMS
{
    public partial class rep_deptIssue : System.Web.UI.Page
    {
        string _connStr;
        protected static readonly ILog Log = LogManager.GetLogger("rep_deptIssue");
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("rep_deptIssue_listing.aspx?sid=" + _emp_sid);
        }
    }
}