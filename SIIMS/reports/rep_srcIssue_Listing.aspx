<%@ Page Title="Issues by Source" Language="C#" MasterPageFile="~/user.Master" AutoEventWireup="true" CodeBehind="rep_srcIssue_Listing.aspx.cs" Inherits="SIIMS.rep_srcIssue_Listing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <th style="text-align:left; font-size:24px; padding:4px; font-family:Arial; font-weight:bold;color:#494949; " >
     Issues by Source  &nbsp; &nbsp; &nbsp; &nbsp; <asp:HyperLink ID="lnkDownload" Font-Size="Medium" runat="server">Export to Excel</asp:HyperLink> 
     </th>
  </tr>
...
where issue.is_active='Y' and issue.stype_id=:STYPE and issue.status_id <> 10
order by 1"   >
 <SelectParameters>
     <asp:SessionParameter DbType="String" SessionField="STitle" Name="STitle" />
