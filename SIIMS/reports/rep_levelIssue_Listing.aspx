<%@ Page Title="Issues by Level" Language="C#" MasterPageFile="~/user.Master" AutoEventWireup="true" CodeBehind="rep_levelIssue_Listing.aspx.cs" Inherits="SIIMS.rep_levelIssue_Listing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <th style="text-align:left; font-size:24px; padding:4px; font-family:Arial; font-weight:bold;color:#494949; " >
     Issues by Level   &nbsp; &nbsp; &nbsp; &nbsp; <asp:HyperLink ID="lnkDownload" Font-Size="Medium" runat="server">Export to Excel</asp:HyperLink> 
     </th>
  </tr>
<tr > <td style="padding:0px; margin:0;">
 <asp:GridView ID="GV_OrgIssues" AllowPaging="True" BackColor="#F1F1F1"  width="100%" CellSpacing="5" PageSize="20"
            AutoGenerateColumns="False" DataSourceID="ds_orgIssues" DataKeyNames="issue_id"  CssClass="gridviewCSS"
           Font-Size="Large"  runat="server" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Level" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="5%">
                    <ItemTemplate>
                       <%#Eval("sig_level") %> 
                      </ItemTemplate>          
...
where issue.is_active='Y' and issue.sig_level=:LID and issue.status_id in (11,12)
order by 1"   >
 <SelectParameters>
     <asp:QueryStringParameter DefaultValue="-1" DbType="String" QueryStringField="level" Name="LID" />
 </SelectParameters>
    </asp:SqlDataSource>  
</asp:Content>
