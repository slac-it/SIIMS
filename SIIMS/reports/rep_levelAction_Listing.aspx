<%@ Page Title="Actions by Owner" Language="C#" MasterPageFile="~/user.Master" AutoEventWireup="true" CodeBehind="rep_levelAction_Listing.aspx.cs" Inherits="SIIMS.rep_levelAction_Listing" %>
 ...
 <asp:GridView ID="GV_srcIssues" AllowPaging="True" BackColor="#F1F1F1"  width="100%" CellSpacing="5" PageSize="20"
           ...
           Font-Size="Large"  runat="server" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Level"  ItemStyle-HorizontalAlign="Left">
                    <ItemTemplate>
                       <%# Eval("sig_level") %>
                    </ItemTemplate>       
...
where action.is_active='Y' and issue.sig_level=:LID and action.status_id <> 20
order by 1, 2"   >
 <SelectParameters>
