<%@ Page Title="View Action" Language="C#" MasterPageFile="~/user.Master" AutoEventWireup="true" CodeBehind="action_view.aspx.cs" Inherits="SIIMS.action_view" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div  class="pageHeader"> Action Details</div>
...
<ItemTemplate>
    <li><asp:LinkButton ID="LnkDownload"  runat="server"  CommandArgument='<%# Eval("ACATT_ID") %>' CommandName="download" Text ='<%# Eval("FILE_NAME") %>'></asp:LinkButton></li>
     ...
     <div style="text-align:center; margin-top:10px;">
       <asp:Button ID="btnCancel" runat="server" Text="Back" Font-Bold="true" Font-Size="X-Large" OnClientClick="JavaScript: window.history.back(1); return false;" />
  </div>
