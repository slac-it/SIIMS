...
namespace SIIMS
{
    public partial class action_delete : System.Web.UI.Page
    {
        ...
        protected static readonly ILog Log = LogManager.GetLogger("action_delete");
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (isIOwner)
            {
                deleteAction(_Action_AID);
            }
            else if (isActOwner)
            {
                requestDeleteAction(_Action_AID);
            }
        ...
        private void requestDeleteAction(int _Action_AID)
        {
            ...
            try
            {
                using (OracleConnection _connection = new OracleConnection())
                {
                    ...
                    _cmd.CommandText = "SIIMS_ACTIONEDIT_PKG.PROC_ACTIONOWNER_DELETE";
            ...
            {
                Log.Error("requestDeleteAction", ex);

            }
        }

        private void deleteAction(int _Action_AID)
        {
            ...
            try
            {
                using (OracleConnection _connection = new OracleConnection())
                {
                    ...
                    _cmd.BindByName = true;
                    _cmd.CommandType = CommandType.StoredProcedure;
                    _cmd.CommandText = "SIIMS_ACTIONEDIT_PKG.PROC_ACTION_DELETE";
