<%@ Page Title="Edit Issue" Language="C#" MasterPageFile="~/user.Master" AutoEventWireup="true" CodeBehind="issue_edit.aspx.cs" Inherits="SIIMS.issue_edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div  class="pageHeader"> Edit Issue</div>
    ...
    <table width="100%" id="editTable">
        ...
        <td style=" text-align:left;">
          ...
          <asp:RequiredFieldValidator ID="RequiredTitle2" ControlToValidate="txtTitle"  ValidationGroup="allFields" runat="server" ForeColor="Red" Display="Dynamic" ErrorMessage="Error: Title is required."></asp:RequiredFieldValidator>
            <asp:HiddenField ID="HiddenSourceTypeID" Value="-1" runat="server" />
        </td>
        </tr>
        ...
        <td style=" text-align:left;">
              <asp:DropDownList ID="drwOrg" AutoPostBack="false"  DataSourceID="ds_Org" DataTextField="name" DataValueField="org_id" runat="server"></asp:DropDownList>
            <br />
   ...
   <asp:Panel ID="PanelSourceType"  Visible="false" runat="server">
          <tr>
     ...
     <tr> <td ></td> <td>
             <div style="text-align:left;margin-top:10px;">
                <div style="font-weight:bold; margin-bottom:10px;">Please select an Assessment:</div>
                 ...
                 <asp:RequiredFieldValidator InitialValue="-1" ID="RequiredFieldValidator3" Display="Dynamic"   ValidationGroup="assSource" runat="server" 
   ...
   <asp:Panel ID="PanelIncident" Visible="false" runat="server">
     ...
     <asp:Panel ID="PanelOtherSelection" Visible="false" runat="server">    
        ...
        <asp:Panel ID="PanelSourceTitle" Visible="false" runat="server">
         ...
         <td style=" text-align:right; font-weight:bold;font-size:1.2em;">Source Title:
             

         </td>
               <td style=" text-align:left;">
                   <asp:TextBox ID="txtSourceTitle" ReadOnly="true" Width="80%" runat="server"></asp:TextBox> 
      ...
      <!--- Resume Upload --->
             <div id="resume" class="window" style="background-color: white;">
                <div style="padding:10px 0px 2px 5px;" class="proTitle">
                    ...
                    <br />  <br /> 
                    <asp:Button runat="server" id="btnUpload" Font-Bold="true" text="Upload"  ValidationGroup="requiredFile"  onclick="btnUpload_Click" />
