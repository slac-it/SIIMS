<%@ Page Title="Delete Issue" Language="C#" MasterPageFile="~/user.Master" AutoEventWireup="true" CodeBehind="issue_delete.aspx.cs" Inherits="SIIMS.issue_delete" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div  class="pageHeader"> Delete Issue</div>
  ...
  <div style="text-align:center; margin-top:20px;">
    <asp:Label ID="lblLockout" Visible="false" CssClass="errorText" runat="server" Text=""></asp:Label> <br />
      <asp:Button ID="btnDelete" runat="server" Text="Delete" Font-Bold="true" Font-Size="X-Large" 
           onclientclick="return confirm(&quot; Are you sure you want to delete the issue?&quot;);" OnClick="btnDelete_Click" /> &nbsp;&nbsp;
