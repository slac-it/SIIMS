<%@ Page Title="Change Level" Language="C#" MasterPageFile="~/user.Master" AutoEventWireup="true" CodeBehind="issue_level.aspx.cs" Inherits="SIIMS.issue_level" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <div  class="pageHeader"> Change Issue Level</div>
  ...
  <td style="width:70%">
    <table width="100%" class="viewTable">    
        ...
        <td style=" text-align:left;">
          ...
          <tr><td style="height:15px;" colspan="2"></td></tr>
          <tr>
              <td style=" text-align:right; font-weight:bold;">New Level: </td>
            <td style=" text-align:left;">
             <asp:DropDownList ID="drwLevel" runat="server">
                  <asp:ListItem Value="-1">-- Please Select New Level --</asp:ListItem>
            ...
            <br />
             <asp:RequiredFieldValidator InitialValue="-1" ID="req_levelDropSelection" Display="Dynamic"   ValidationGroup="levelDropSelection" runat="server" 
                           ControlToValidate="drwLevel"   ForeColor="Red"  ErrorMessage="Error: please selection a new level!"></asp:RequiredFieldValidator>
                <asp:Label ID="lblLevelCheck" Visible="false" runat="server" ForeColor="Red" Text="The new level must be different from the existing level."></asp:Label>
...
<tr > <td style="padding:0px; margin:0;">
 <asp:GridView ID="GVActions" AllowPaging="True" BackColor="#f1f1f1"  width="100%" CellSpacing="5" PageSize="10"
  ...
  <div style="text-align:center; margin-top:20px;">
   ...
   <asp:Button ID="btnSubmit" runat="server" Text="Submit" Font-Bold="true" Font-Size="X-Large"  OnClick="btnSubmit_Click" 
            ValidationGroup="levelDropSelection"     /> &nbsp;&nbsp;
&nbsp;&nbsp;
