<%@ Page Title="Edit SMT Org" Language="C#" MasterPageFile="~/admin/adminMaster.Master" AutoEventWireup="true" CodeBehind="org_edit.aspx.cs" Inherits="SIIMS.admin.org_edit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div  class="pageHeader"> Edit SMT Organization</div>
    ...
    <table width="100%" id="editTable">
        ...
        <td style=" text-align:left;">
            ...
            <asp:RequiredFieldValidator ID="RequiredFD2" ControlToValidate="txtManager_SID" ValidationGroup="allFields" runat="server" ForeColor="Red" Display="Dynamic" ErrorMessage="Error: Manager's SLAC ID is required."></asp:RequiredFieldValidator>
           <asp:CompareValidator runat="server" Operator="DataTypeCheck" Type="Integer"  ForeColor="Red" Display="Dynamic" ValidationGroup="allFields"
 ControlToValidate="txtManager_SID" ErrorMessage="Error: Manager's SLAC ID must be a whole number" /> 
       ...
       <tr>
        ...
        <td style=" text-align:left;">
            ...
            <asp:RequiredFieldValidator ID="RequiredFD3" ControlToValidate="txtPOC_SID" ValidationGroup="allFields" runat="server" ForeColor="Red" Display="Dynamic" ErrorMessage="Error: POC's SLAC ID is required."></asp:RequiredFieldValidator>
             <asp:CompareValidator runat="server" Operator="DataTypeCheck" Type="Integer"  ForeColor="Red" Display="Dynamic" ValidationGroup="allFields"
     ...
     <tr style="margin-top:20px;">
        <td colspan="2"  style="text-align:center;">    
          ...
          <asp:Button ID="btnSubmit" runat="server" Text="Submit" Visible="false" Font-Bold="true" Font-Size="X-Large" ValidationGroup="allFields" OnClick="btnSubmit_Click" /> 
            &nbsp;&nbsp; &nbsp;&nbsp;  &nbsp;&nbsp; &nbsp;&nbsp; 
            <asp:Button ID="btnReset" runat="server" Text="Reset" Font-Bold="true" Font-Size="X-Large" OnClick="btnReset_Click"   />
            &nbsp;&nbsp; &nbsp;&nbsp; 
