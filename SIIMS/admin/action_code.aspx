<%@ Page Title="Assign Action Types" Language="C#" MasterPageFile="~/admin/adminMaster.Master" AutoEventWireup="true" CodeBehind="action_code.aspx.cs" Inherits="SIIMS.admin.action_code" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div  class="pageHeader">Assign Action Types</div>
     ...
     <asp:GridView ID="gvw1" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="20"  CellPadding="5" AllowSorting="true"
         ...
         <Columns>
             ...
             <asp:TemplateField HeaderText="Action Title" ItemStyle-HorizontalAlign="Left" SortExpression="sTitle" ItemStyle-Width="30%">
                    <ItemTemplate>
                         <a href='action_assignCode.aspx?from=a&aid=<%# Eval("aid") %>'><%# Eval("aTitle") %></a>   
                      </ItemTemplate>          
                </asp:TemplateField>
...
AND (ac.CAT_ACODE_ID is null or ac.SUB_ACODE_ID is null)
order by 1"> 
        </asp:SqlDataSource>
